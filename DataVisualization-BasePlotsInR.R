...
#For extended mosaic plots, use mosaic(x, condvar=, data=) 
#where x is a table or formula, condvar= is an optional conditioning variable, 
#and data= specifies a data frame or a table. 
#Include shade=TRUE to color the figure, and legend=TRUE to display a legend for the Pearson residuals.
mosaic(x=dftable_1, shade=TRUE, legend=TRUE)
